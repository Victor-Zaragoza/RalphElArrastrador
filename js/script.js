...
const arreglOriginal = [
  ...
  {
    animal: "Canguro",
    imagenAnimal: "/multimedia/images/canguro.png",
    imagenHabitat: "h-canguro.png",
    audioCorrecto: "",
  },
  {
    animal: "Vaca",
...
function soltado(e) {
  ...
  if (nombreAnimalArrastrado === nombreHabitatSoltable) {
    ...
    if (puntuacion == 6) {
      //Agregar botón para pantalla de felicitación
      document.getElementById("divBoton").innerHTML ='<button id="boton" type="button" >Felicitación!</button>';
    }
  } else {
